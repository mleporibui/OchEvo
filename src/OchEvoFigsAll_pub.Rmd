...
dat100<-read_csv(here("data","OECD100.csv"))
dat50<-read_csv(here("data","OECD50.csv"))
...
pe <- read_csv(here("data","pestats_trc3.2.csv")) 
graz <- read_csv(here("data","TRC_grazstats_dilution.csv")) 
