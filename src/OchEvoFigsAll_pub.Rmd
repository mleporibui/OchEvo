...
```{r, echo = FALSE, warning = FALSE}
# dataframe for grazing, convert to pgC per pgC per day using CN data from week141
...
```{r}
# calculate carbon use efficiency end of experiment data points for growth rate and respiration from 
...
a0 <- ggplot(subset(CUE.summ.100, Ev==Acc & Strain == strainchoice), 
  ...
  annotate("text", x= 18,  y = .5, label = points.sig[points.sig$Ev==18,]$p.value.cue) +
  annotate("text", x= 30,  y = .5, label = points.sig[points.sig$Ev==30,]$p.value.cue)

a1<-ggplot(subset(Growth.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Growth.Rate, color=as.factor(Ev))) + 
  ...
  theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
  labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(Growth.summ.100, Ev==24 & Strain == strainchoice),aes(ymin=Growth.Rate-se, ymax=Growth.Rate+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = .15, label = points.sig[points.sig$Ev==18,]$p.value.growth) +
  annotate("text", x= 30,  y = .15, label = points.sig[points.sig$Ev==30,]$p.value.growth)
 

# Red f 
a2<-ggplot(subset(redf.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=redf, color=as.factor(Ev))) + 
...
theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
  labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(redf.summ.100, Ev==24 & Strain == strainchoice),aes(ymin=redf-se, ymax=redf+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = 16, label = points.sig[points.sig$Ev==18,]$p.value.redf) +
  annotate("text", x= 30,  y = 16, label = points.sig[points.sig$Ev==30,]$p.value.redf)
...
theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(C.summ.100, Ev==24 & Strain == strainchoice),aes(ymin=C-se, ymax=C+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = 14, label = points.sig[points.sig$Ev==18,]$p.value.c) +
  annotate("text", x= 30,  y = 14, label = points.sig[points.sig$Ev==30,]$p.value.c)
...
theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
 labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(Resp.summ.100, Ev==24 & Strain == strainchoice),aes(ymin=Resp-se, ymax=Resp+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = 2, label = points.sig[points.sig$Ev==18,]$p.value.resp) +
  annotate("text", x= 30,  y = 1.5, label = points.sig[points.sig$Ev==30,]$p.value.resp)
...
a5 <- ggplot(subset(Photo.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Photo, color=as.factor(Ev))) + 
 ...
 theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
  labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(Photo.summ.100, Ev==24 & Strain == strainchoice),aes(ymin=Photo-se, ymax=Photo+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = .6, label = points.sig[points.sig$Ev==18,]$p.value.photo) +
  annotate("text", x= 30,  y = .4, label = points.sig[points.sig$Ev==30,]$p.value.photo)
...
a6 <- ggplot(subset(Graz.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=graz, color=as.factor(Ev))) + 
  ...
  theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
 labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(Graz.summ.100, Ev==24 & Strain == strainchoice),aes(ymin=graz-se, ymax=graz+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = .12, label = points.sig[points.sig$Ev==18,]$p.value.graz) +
  annotate("text", x= 30,  y = .12, label = points.sig[points.sig$Ev==30,]$p.value.graz)
...
theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(fvfm.summ.100, Ev==24 & Strain == strainchoice),aes(ymin=fvfm-se, ymax=fvfm+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = .425, label = points.sig[points.sig$Ev==18,]$p.value.fvfm) +
  annotate("text", x= 30,  y = .425, label = points.sig[points.sig$Ev==30,]$p.value.fvfm)
...
b0 <- ggplot(subset(CUE.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=CUE, color=as.factor(Ev))) + 
  geom_errorbar(aes(ymin=CUE-se, ymax=CUE+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
  ...
  theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(CUE.summ.100, Ev==24 & Strain == strainchoice),aes(ymin=CUE-se, ymax=CUE+se, width = .2), color = "gray48") +
  geom_line(data = subset(CUE.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(CUE.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .92, label = points.sig[points.sig$Ev==18,]$p.value.cue) +
  annotate("text", x= 30,  y = .85, label = points.sig[points.sig$Ev==30,]$p.value.cue)

b1<-ggplot(subset(Growth.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Growth.Rate, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Growth.Rate-se, ymax=Growth.Rate+se), width=.2) +
    scale_color_manual(values=newcols) +
  scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
labs( y = NULL, x=NULL) +
  ...
  geom_line(data = subset(Growth.summ.100, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(Growth.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .6, label = points.sig[points.sig$Ev==18,]$p.value.growth) +
  annotate("text", x= 30,  y = .6, label = points.sig[points.sig$Ev==30,]$p.value.growth)
 

# Red f 
b2<-ggplot(subset(redf.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=redf, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=redf-se, ymax=redf+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
labs( y = NULL, x=NULL) +
  ...
  geom_line(data = subset(redf.summ.100, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(redf.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = 14, label = points.sig[points.sig$Ev==18,]$p.value.redf) +
  annotate("text", x= 30,  y = 11, label = points.sig[points.sig$Ev==30,]$p.value.redf)
...
b3<-ggplot(subset(C.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=C, color=as.factor(Ev))) + 
  ...
  geom_line(data = subset(C.summ.100, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(C.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = 13, label = points.sig[points.sig$Ev==18,]$p.value.c) +
  annotate("text", x= 30,  y = 13, label = points.sig[points.sig$Ev==30,]$p.value.c)

# Resp
b4 <- ggplot(subset(Resp.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Resp, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Resp-se, ymax=Resp+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
 ...
 theme(legend.position = "none",
  ...
  geom_line(data = subset(Resp.summ.100, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(Resp.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = 1.25, label = points.sig[points.sig$Ev==18,]$p.value.resp) +
  annotate("text", x= 30,  y = 1.25, label = points.sig[points.sig$Ev==30,]$p.value.resp)

# Photo
b5 <- ggplot(subset(Photo.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Photo, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Photo-se, ymax=Photo+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
theme(legend.position = "none",
  ...
  geom_line(data = subset(Photo.summ.100, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(Photo.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .4, label = points.sig[points.sig$Ev==18,]$p.value.photo) +
  annotate("text", x= 30,  y = .4, label = points.sig[points.sig$Ev==30,]$p.value.photo)

# Graz
b6 <- ggplot(subset(Graz.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=graz, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=graz-se, ymax=graz+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
labs( y = NULL, x=NULL) +
  ...
  geom_line(data = subset(Graz.summ.100, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(Graz.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .2, label = points.sig[points.sig$Ev==18,]$p.value.graz) +
  annotate("text", x= 30,  y = .2, label = points.sig[points.sig$Ev==30,]$p.value.graz)

# fvfm
b7<-ggplot(subset(fvfm.summ.100, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=fvfm, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=fvfm-se, ymax=fvfm+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
theme(legend.position = "none",
 ...
 labs( y = NULL, x=NULL) +
  ...
  geom_line(data = subset(fvfm.summ.100, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(fvfm.summ.100, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .5, label = points.sig[points.sig$Ev==18,]$p.value.fvfm) +
  annotate("text", x= 30,  y = .5, label = points.sig[points.sig$Ev==30,]$p.value.fvfm)
...
points.sig <- pvals.df.50.2.sig %>% 
  filter(Strain == strainchoice) 

c0 <- ggplot(subset(CUE.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=CUE, color=as.factor(Ev))) + 
  geom_errorbar(aes(ymin=CUE-se, ymax=CUE+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
 ...
 labs( y = NULL, x=NULL) +
  ...
  annotate("text", x= 18,  y = .88, label = points.sig[points.sig$Ev==18,]$p.value.cue) +
  annotate("text", x= 30,  y = .8, label = points.sig[points.sig$Ev==30,]$p.value.cue)

c1<-ggplot(subset(Growth.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Growth.Rate, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Growth.Rate-se, ymax=Growth.Rate+se), width=.2) +
    scale_color_manual(values=newcols) +
  scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
  ...
  theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
 labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(Growth.summ.50, Ev==24 & Strain == strainchoice),aes(ymin=Growth.Rate-se, ymax=Growth.Rate+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = .3, label = points.sig[points.sig$Ev==18,]$p.value.growth) +
  annotate("text", x= 30,  y = .3, label = points.sig[points.sig$Ev==30,]$p.value.growth)
 

# Red f 
c2<-ggplot(subset(redf.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=redf, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=redf-se, ymax=redf+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
 ...
 theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
 labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(redf.summ.50, Ev==24 & Strain == strainchoice),aes(ymin=redf-se, ymax=redf+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = 15, label = points.sig[points.sig$Ev==18,]$p.value.redf) +
  annotate("text", x= 30,  y = 15, label = points.sig[points.sig$Ev==30,]$p.value.redf)


# C
c3<-ggplot(subset(C.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=C, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=C-se, ymax=C+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
 ...
 theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(C.summ.50, Ev==24 & Strain == strainchoice),aes(ymin=C-se, ymax=C+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = 22, label = points.sig[points.sig$Ev==18,]$p.value.c) +
  annotate("text", x= 30,  y = 22, label = points.sig[points.sig$Ev==30,]$p.value.c)

# Resp
c4 <- ggplot(subset(Resp.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Resp, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Resp-se, ymax=Resp+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
  ...
  theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
  labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(Resp.summ.50, Ev==24 & Strain == strainchoice),aes(ymin=Resp-se, ymax=Resp+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = 2, label = points.sig[points.sig$Ev==18,]$p.value.resp) +
  annotate("text", x= 30,  y = 2, label = points.sig[points.sig$Ev==30,]$p.value.resp)

# Photo
c5 <- ggplot(subset(Photo.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Photo, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Photo-se, ymax=Photo+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
  ...
  theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
  labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(Photo.summ.50, Ev==24 & Strain == strainchoice),aes(ymin=Photo-se, ymax=Photo+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = .9, label = points.sig[points.sig$Ev==18,]$p.value.photo) +
  annotate("text", x= 30,  y = .9, label = points.sig[points.sig$Ev==30,]$p.value.photo)

# Graz
c6 <- ggplot(subset(Graz.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=graz, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=graz-se, ymax=graz+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
 ...
 theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(Graz.summ.50, Ev==24 & Strain == strainchoice),aes(ymin=graz-se, ymax=graz+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = .3, label = points.sig[points.sig$Ev==18,]$p.value.graz) +
  annotate("text", x= 30,  y = .3, label = points.sig[points.sig$Ev==30,]$p.value.graz)

# fvfm
c7<-ggplot(subset(fvfm.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=fvfm, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=fvfm-se, ymax=fvfm+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
theme(legend.position = "none",
    ...
    geom_point(size=3, aes()) +
labs( y = NULL, x=NULL) +
  geom_errorbar(data = subset(fvfm.summ.50, Ev==24 & Strain == strainchoice),aes(ymin=fvfm-se, ymax=fvfm+se, width = .2), color = "gray48") +
  ...
  annotate("text", x= 18,  y = .48, label = points.sig[points.sig$Ev==18,]$p.value.fvfm) +
  annotate("text", x= 30,  y = .48, label = points.sig[points.sig$Ev==30,]$p.value.fvfm)

# N
c8<-ggplot(subset(N.summ.100.2, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=N, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=N-se, ymax=N+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
d0 <- ggplot(subset(CUE.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=CUE, color=as.factor(Ev))) + 
  geom_errorbar(aes(ymin=CUE-se, ymax=CUE+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
labs( y = NULL, x=NULL) +
  ...
  geom_line(data = subset(CUE.summ.50, Ev==24 & Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(CUE.summ.50, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .8, label = points.sig[points.sig$Ev==18,]$p.value.cue) +
  annotate("text", x= 30,  y = .8, label = points.sig[points.sig$Ev==30,]$p.value.cue)

d1<-ggplot(subset(Growth.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Growth.Rate, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Growth.Rate-se, ymax=Growth.Rate+se), width=.2) +
    scale_color_manual(values=newcols) +
  scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
 ...
 labs( y = NULL, x=NULL) +
  ...
  geom_line(data = subset(Growth.summ.50, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(Growth.summ.50, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .4, label = points.sig[points.sig$Ev==18,]$p.value.growth) +
  annotate("text", x= 30,  y = .3, label = points.sig[points.sig$Ev==30,]$p.value.growth)
 

# Red f 
d2<-ggplot(subset(redf.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=redf, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=redf-se, ymax=redf+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
 ...
 labs( y = NULL, x=NULL) +
  ...
  geom_line(data = subset(redf.summ.50, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(redf.summ.50, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = 10.5, label = points.sig[points.sig$Ev==18,]$p.value.redf) +
  annotate("text", x= 30,  y = 10.5, label = points.sig[points.sig$Ev==30,]$p.value.redf)


# C
d3<-ggplot(subset(C.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=C, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=C-se, ymax=C+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
labs( y = NULL, x=NULL) +
  ...
  geom_line(data = subset(C.summ.50, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(C.summ.50, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = 15, label = points.sig[points.sig$Ev==18,]$p.value.c) +
  annotate("text", x= 30,  y = 15, label = points.sig[points.sig$Ev==30,]$p.value.c)

# Resp
d4 <- ggplot(subset(Resp.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Resp, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Resp-se, ymax=Resp+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
  ...
  geom_line(data = subset(Resp.summ.50, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(Resp.summ.50, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = 1.5, label = points.sig[points.sig$Ev==18,]$p.value.resp) +
  annotate("text", x= 30,  y = 1.5, label = points.sig[points.sig$Ev==30,]$p.value.resp)

# Photo
d5 <- ggplot(subset(Photo.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=Photo, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=Photo-se, ymax=Photo+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
  ...
  geom_line(data = subset(Photo.summ.50, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(Photo.summ.50, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .8, label = points.sig[points.sig$Ev==18,]$p.value.photo) +
  annotate("text", x= 30,  y = .4, label = points.sig[points.sig$Ev==30,]$p.value.photo)

# Graz
d6 <- ggplot(subset(Graz.summ.50, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=graz, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=graz-se, ymax=graz+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
  ...
  geom_line(data = subset(Graz.summ.50, Ev==24 &Strain == strainchoice), color = "gray48", linetype = "dashed") +
  geom_point(data = subset(Graz.summ.50, Ev==24 & Strain == strainchoice), color = "gray48", aes())+
  annotate("text", x= 18,  y = .25, label = points.sig[points.sig$Ev==18,]$p.value.graz) +
  annotate("text", x= 30,  y = .3, label = points.sig[points.sig$Ev==30,]$p.value.graz)
...
d7<-ggplot(subset(fvfm.summ.50, Ev==Acc & Strain == strainchoice), 
 ...
 theme(legend.position = "none",
  ...
  geom_point(data = subset(fvfm.summ.50, Ev==24 & Strain == strainchoice), 
             color = "gray48", aes())+
  annotate("text", x= 18,  y = .55, label = points.sig[points.sig$Ev==18,]$p.value.fvfm) +
  annotate("text", x= 30,  y = .53, label = points.sig[points.sig$Ev==30,]$p.value.fvfm)

# N
d8<-ggplot(subset(N.summ.100.2, Ev==Acc & Strain == strainchoice), aes(x=Acc, y=N, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=N-se, ymax=N+se), width=.2) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     breaks = c(18,24,30),
...
First, each temperature seperately
...
s1.5<- ggplot(redf.corr.summ.100.1393.time, 
       aes(x=Acc, y=redf.corr, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=redf.corr-se, ymax=redf.corr+se), width=1) +
    geom_line(lwd = 1) +
    geom_point(size = 3)+
   facet_grid(cols = vars(Week)) +
    scale_color_manual(values=newcols) +
    scale_x_continuous(limits = c(17,31),
                     ...
                     expand = c(0,0)) +
    theme(legend.position = "none") 
s1.6<- ggplot(redf.corr.summ.50.1393.time, 
       aes(x=Acc, y=redf.corr, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=redf.corr-se, ymax=redf.corr+se), width=1) +
    geom_line(lwd = 1) +
    geom_point(size = 3)+
...
s1.7<- ggplot(redf.corr.summ.100.2951.time, 
       aes(x=Acc, y=redf.corr, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=redf.corr-se, ymax=redf.corr+se), width=1) +
    geom_line(lwd = 1) +
    geom_point(size = 3)+
   facet_grid(cols = vars(Week)) +
    ...
    scale_x_continuous(limits = c(17,31),
                     ...
                     expand = c(0,0)) +
    theme(legend.position = "none") 
s1.8<- ggplot(redf.corr.summ.50.2951.time, 
       aes(x=Acc, y=redf.corr, color=as.factor(Ev))) + 
    geom_errorbar(aes(ymin=redf.corr-se, ymax=redf.corr+se), width=1) +
    geom_line(lwd = 1) +
    geom_point(size = 3)+
